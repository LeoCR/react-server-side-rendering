...
export const ServicesIcons =()=> {  
    ...
    return(
        <div id="icons-services-div" style={{width:'100%',position:'relative',
            ...
            <Link to="/services/web-development" data-href="/services/web-development"  className="icon-service" onClick={()=>getService()}>
            ...
            <Link to="/services/ecommerce" data-href="/services/ecommerce"  className="icon-service" onClick={()=>getService()}>
                <figure id="figure_ecommerce" className="service_icon_btn" style={{width:'250px',
                float:'left',minHeight:'250px',position:'relative'}}>
                    <IconEcommerce/>
                </figure>
            </Link>
            <Link to="/services/cloud-development" data-href="/services/cloud-development"  className="icon-service" onClick={()=>getService()}>
